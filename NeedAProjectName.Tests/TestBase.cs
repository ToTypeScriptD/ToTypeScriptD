...
namespace NeedAProjectName.Tests
{
    ...
    public class TestBase
    {
        ...
        public string NativeComponentPath { get { return @"NeedAProjectName.Native.winmd"; } }
        ...
        {
            return NativeModule.Types.Where(s => s.FullName == "NeedAProjectName.Native." + name).Single();
        }
